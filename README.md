...
2. Download and install Godot 4.5 and import the directory
3. Open the game in Godot and press the play button

## Contributing
If you have a feature request or have found a bug/performance improvement, you may submit an issue or pull request.

## TODO
- [ ] Decide on a name and create a logo
